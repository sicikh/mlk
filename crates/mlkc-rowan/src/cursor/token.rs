...
use crate::{
    Direction, GreenToken, GreenTokenData, RawSyntaxKind, TokenText, WalkEvent,
    cursor::{NodeData, SyntaxElement, SyntaxNode, SyntaxTrivia},
    green,
...
impl SyntaxToken {
    ...
    pub fn siblings_with_tokens(
        ...
        let next = move |el: &SyntaxElement| {
            match direction {
