...
impl<L: Language> SyntaxNode<L> {
    ...
    /// the corresponding language (eg. `mlkc_js_factory::make`)
    ...
    /// let new_node = node
    ///     .clone()
    ///     .prepend_trivia_pieces(node.last_trailing_trivia().unwrap().pieces())
    ///     .unwrap();
    ...
    /// let new_node = node
    ///     .clone()
    ///     .append_trivia_pieces(node.first_leading_trivia().unwrap().pieces())
    ///     .unwrap();
    /// let leading_trivia = new_node.first_leading_trivia().unwrap();
    /// let trailing_trivia = new_node.last_trailing_trivia().unwrap();
    ///
