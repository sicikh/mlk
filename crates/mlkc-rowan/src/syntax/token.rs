...
use crate::{
    ...
    syntax::{SyntaxTrivia, element::SyntaxElementKey},
...
impl<L: Language> SyntaxToken<L> {
    ...
    ///
    /// ```
    /// use mlkc_rowan::raw_language::{RawLanguage, RawLanguageKind};
    /// use mlkc_rowan::{RawSyntaxToken, SyntaxToken, TriviaPiece};
    ///
