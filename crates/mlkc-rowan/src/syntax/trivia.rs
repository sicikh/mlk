use std::{fmt, fmt::Formatter, iter::FusedIterator, marker::PhantomData};
...
/// ```
/// use mlkc_rowan::{
///     RawSyntaxToken, SyntaxToken, TriviaPiece,
///     raw_language::{RawLanguage, RawLanguageKind},
...
/// );
/// let new_token = token
///     .with_leading_trivia_pieces(trim_leading_trivia_pieces(token.leading_trivia().pieces()));
///
/// assert_eq!(
///     format!("{:?}", new_token),
...
/// );
/// let new_token = token
///     .with_leading_trivia_pieces(trim_trailing_trivia_pieces(token.leading_trivia().pieces()));
///
/// assert_eq!(
///     format!("{:?}", new_token),
...
///
/// ```
/// use mlkc_rowan::raw_language::{RawLanguage, RawLanguageKind, RawSyntaxTreeBuilder};
/// use mlkc_rowan::{chain_trivia_pieces, RawSyntaxToken, SyntaxToken, TriviaPiece, TriviaPieceKind};
///
