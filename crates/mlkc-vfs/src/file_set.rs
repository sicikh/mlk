...
/// file_system.set_file_contents(
///     VfsPath::new_virtual_path("/src/main.rs".to_string()),
///     Some(vec![]),
/// );
/// file_system.set_file_contents(
///     VfsPath::new_virtual_path("/src/lib.rs".to_string()),
///     Some(vec![]),
/// );
/// file_system.set_file_contents(
///     VfsPath::new_virtual_path("/build.rs".to_string()),
///     Some(vec![]),
/// );
/// // contains the sets :
