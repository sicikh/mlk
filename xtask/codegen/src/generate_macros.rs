...
use super::mlk_kinds_src::AstSrc;
use crate::{Result, language_kind::LanguageKind};
...
pub fn generate_macros(ast: &AstSrc, language_kind: LanguageKind) -> Result<String> {
    ...
    let ast = quote! {
        ...
        ///
        /// This macros performs a match over the [kind](mlkc_rowan::SyntaxNode::kind)
        /// of the provided [mlkc_rowan::SyntaxNode] and constructs the appropriate
